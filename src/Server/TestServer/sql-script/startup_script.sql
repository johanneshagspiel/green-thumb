CREATE DATABASE thegreenthumb_database;

CREATE USER 'thegreenthumb'@'localhost' IDENTIFIED BY 'thegreenthumb';

GRANT ALL PRIVILEGES ON * . * TO 'thegreenthumb'@'localhost';

FLUSH PRIVILEGES;

USE `thegreenthumb_database`;
...
INSERT INTO thegreenthumb_database.user
...
INSERT INTO thegreenthumb_database.friend
VALUES(1, "Test", "Test5");
